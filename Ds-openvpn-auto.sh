...
echo ""
echo -e " =============== OS-32 & 64-bit =================    "
echo -e "#    OS  DEBIAN 7-8-9  OS  UBUNTU 14-16-18      #    "
echo -e "#               { VPN / SSH }                   #    "
echo -e "#             BY : DeathSide VPN                #    "
echo -e " =============== OS-32 & 64-bit =================    "
echo -e "${RED} ไอพีเซิฟ: $IP "
echo -e "${NC} "
...
END
	...
	echo "<pre>By  DeathSide VPN</pre>" > /home/vps/public_html/index.html
